# Notification bots
    ...
    - [x] Price notifications
        - [x] Only send one notification per market in the 1m 5m 1h etc. buckets
        - [x] Show the direction (up or down) of the price change
        - [x] Only trigger a notif if the yes and no tokens have both changed in price
        - [x] Once a notification has been sent, truncate the price to that time
        - [x] Refactor the price time series to be a pandas series to make downstream logic easier

    - [x] Price data
        - [x] Parallelize getting the price data from markets
    ...
    - [ ] Figure out how to put this in a groupchat
